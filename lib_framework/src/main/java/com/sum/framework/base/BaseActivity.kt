...
import com.sum.framework.utils.LoadSuccessUtils
...
abstract class BaseActivity : AppCompatActivity() {
    ...
    private val dialogSuccessUtils by lazy {
        LoadSuccessUtils(this)
    }
    ...
    fun showSuccess() {
        dialogSuccessUtils.showLoading("")
    }

    fun dismissSuccess() {
        dialogSuccessUtils.dismissLoading()
    }
