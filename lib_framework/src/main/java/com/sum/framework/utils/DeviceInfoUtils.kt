...
object DeviceInfoUtils {
    ...
    fun getPhoneNum(activity: FragmentActivity) {
        LogUtil.d("show hone")
        ...
        startIntentSenderForResult(activity,
            IntentSenderRequest.Builder(intent).build().intentSender,
    ...
    fun hideInputView(view: View) {
        val inputMethodManager = appContext.getSystemService(Context.INPUT_METHOD_SERVICE) as InputMethodManager
